...
from scrapy_dit.models import PCDWaste_Listing, PCDWaste_LocalGov, db_connect, create_table
from scrapy_dit.items import PCDWaste_Listing_Item, PCDWaste_LocalGov_Item
import logging
...
class ScrapyDitPipeline(object):
